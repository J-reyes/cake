...
var impressionsSchema = new Schema({
    timeStamp: String,
    campaign: String,
    affiliate: String,
    userAgent: String,
...
impressionsSchema.statics.findWithFraud = async function () {
    try {
        ...
        return allImpressions.map((t, index) => ({ ...t._doc, fraud: output[index] }));
    } catch (err) {
        return err;
    }
}
...
var Impression = mongoose.model('transaction', transactionSchema);
